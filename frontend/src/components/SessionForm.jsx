...
const ROWS_1D = [
  ...
  { kind: 'number', label: 'Liquidation discount (fraction per $ of shortfall)',
    source: 'adv:r_borrow_annual', step: 'any', min: 0,
    range: '0.02 – 0.30',
    desc: 'Dollars lost per dollar of shortfall on days when cash goes negative — the forced-sale friction. 0.10 = 10 cents lost per dollar of shortfall. Despite the field name (r_borrow_annual, kept for backend compatibility), this is a proportional friction, not an annualized interest rate.' },
