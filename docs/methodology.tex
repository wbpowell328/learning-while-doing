...
candidate values $C^*_1, C^*_2, \dots$, observes a noisy realization of
$F(C^*_i)$ after each choice, and updates their belief about $F$.
...
choosing the next $C^*$: pure exploration (Random), a family of
